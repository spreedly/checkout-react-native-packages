...
### 🐛 Fixed
  ...
  - Integration guide updating fixed (823c1fd)
...
### ✨ Added
  ...
  - Pull before push to publish repo (dfcd007)
...
### ✨ Added
  ...
  - Humanized changelog fix (4a093fe)
  - Humanized changelog and integration guide changes push to new repo automatically (541333e)
